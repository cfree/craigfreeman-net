...
function cfree_scripts() {
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
		...
		wp_enqueue_style( 'cfree-style', get_template_directory_uri() . '/assets/dist/styles.min.css', array(), CF_ASSETS_VERSION );

		wp_enqueue_script( 'cfree-scripts', get_template_directory_uri() . '/assets/dist/scripts.min.js', array( 'modernizr', 'jquery' ), CF_ASSETS_VERSION, true );
	}
